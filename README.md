...
> Aspiring Penetration Tester | Network Security Enthusiast | CTF Player

I'm building hands-on cybersecurity skills through home lab projects, CTF challenges, and security research. Currently focused on offensive security and network penetration testing.

---

## 🎯 Focus Areas

- **Red Team / Offensive Security** — exploitation, post-exploitation, lateral movement
- **Network Penetration Testing** — reconnaissance, enumeration, vulnerability assessment
- **CTF** — actively solving challenges on HackTheBox and TryHackMe
...
[![TryHackMe](https://tryhackme-images.s3.amazonaws.com/capability-score/andawakin.png)](https://tryhackme.com/p/andawakin)
